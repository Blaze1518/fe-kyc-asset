...
export interface DataTableProps<TData> {
  ...
  pageCount: number;
  state: RecordListParams;
  onStateChange: (state: RecordListParams) => void;
    ...
    <div className="w-full space-y-4">
      <>
        <DataTableToolbar
          table={table}
          state={state.search ?? {}}
          onSubmitFilters={({ name, clientTimestampFrom, clientTimestampTo }) =>
            onStateChange({
              ...state,
              page: 0,
              search: { name, clientTimestampFrom, clientTimestampTo },
            })
          }
        />
